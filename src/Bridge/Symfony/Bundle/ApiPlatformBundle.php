...
use ApiPlatform\Core\Bridge\Symfony\Bundle\DependencyInjection\Compiler\FosElasticaQueryExtensionPass;
...
final class ApiPlatformBundle extends Bundle
{
    ...
    public function build(ContainerBuilder $container)
    {
        ...
        $container->addCompilerPass(new FosElasticaQueryExtensionPass());
    }
}
